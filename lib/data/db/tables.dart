...
class SyncMeta extends Table {
  ...
  // P-G1 — JSON list of staff positions allowed to open the Kitchen
  // production screen (`settings.kitchen_positions`). null = managers-only
  // fallback.
  TextColumn get kitchenPositions => text().nullable()();
